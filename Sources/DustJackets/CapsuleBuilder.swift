...
@resultBuilder struct CapsuleBuilder {
    ...
    static func buildBlock<C0>(_ c0: C0)
        -> Capsule<C0, Color> where C0 : View {
            Capsule(.white) { c0 }
    }
    
    static func buildBlock<C0, C1>(_ c0: C0, _ c1: C1)
        -> TupleView<(Capsule<C0, Color>, Capsule<C1, Color>)> where C0 : View, C1 : View {
            TupleView((Capsule(.white) { c0 }, Capsule(.white) { c1 }))
    }
    
    static func buildBlock<C0, C1, C2>(_ c0: C0, _ c1: C1, _ c2: C2)
        -> TupleView<(Capsule<C0, Color>, Capsule<C1, Color>, Capsule<C2, Color>)> where C0 : View, C1 : View, C2 : View {
    ...
    static func buildBlock<C0, C1, C2, C3>(_ c0: C0, _ c1: C1, _ c2: C2, _ c3: C3)
        -> TupleView<(Capsule<C0, Color>, Capsule<C1, Color>, Capsule<C2, Color>, Capsule<C3, Color>)> where C0 : View, C1 : View, C2 : View, C3 : View {
    ...
    static func buildBlock<C0, C1, C2, C3, C4>(_ c0: C0, _ c1: C1, _ c2: C2, _ c3: C3, _ c4: C4)
        -> TupleView<(Capsule<C0, Color>, Capsule<C1, Color>, Capsule<C2, Color>, Capsule<C3, Color>, Capsule<C4, Color>)>
    ...
    static func buildBlock<C0, C1, C2, C3, C4, C5>(_ c0: C0, _ c1: C1, _ c2: C2, _ c3: C3, _ c4: C4, _ c5: C5)
        -> TupleView<(Capsule<C0, Color>, Capsule<C1, Color>, Capsule<C2, Color>, Capsule<C3, Color>, Capsule<C4, Color>, Capsule<C5, Color>)>
